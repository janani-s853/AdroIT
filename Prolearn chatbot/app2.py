...
faq_exact = {
    ...
    "how do i contact support for technical issues?": "Use 'Help' on prolearn or contact your instructor.",
    "can i access prolearn on my mobile?": "Yes, it's mobile compatible.",
...
faq_keywords = {
    ...
    ("mobile", "access on phone", "can i use on phone"): "• Yes, prolearn works on mobile browsers and may have an app.",
