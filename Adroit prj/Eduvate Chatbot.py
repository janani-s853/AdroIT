...
class Eduvate:
    def __init__(self, master):
        ...
        self.faq = {
            "how do i login to eduvate?": "Enter the username and password provided to you and click on the 'Login' button.",
            ...
            "how do i contact support for technical issues?": "Use the 'Help' or 'Support' section on eduvate or contact your instructor for assistance.",
            "can i access eduvate on my mobile?": "Yes, eduvate is accessible via mobile browsers, and in some cases, a mobile app might be available.",
            ...
            "how do i log out of eduvate?": "Click on your profile icon in the top right corner and select 'Logout'.",
    ...
    def send_message(self,event=None):
        ...
        if response:
            ...
            self.set_dark_mode()
            self.display_message("Eduvate Chatbot: Dark mode activated")
        elif "light mode" in user_input or "switch to light mode" in user_input:
            self.set_light_mode()
            self.display_message("Eduvate Chatbot: Light mode activated")
            ...
            self.edit_mode = True
            self.display_message("Eduvate Chatbot: Edit mode is on.")
        elif "edit mode off" in user_input:
            self.edit_mode = False
            self.display_message("Eduvate Chatbot: Edit mode is off.")
        elif "open block drawer" in user_input:
            self.block_drawer_open = True
            self.display_message("Eduvate Chatbot: Block drawer opened.")
        elif "close block drawer" in user_input:
            self.block_drawer_open = False
            self.display_message("Eduvate Chatbot: Block drawer closed.")
        else:
            self.display_message("Eduvate Chatbot: Can you provide more information on what you need?")
