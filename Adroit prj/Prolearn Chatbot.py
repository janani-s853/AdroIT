...
class Prolearn:
    def __init__(self, master):
        ...
        self.faq_keywords = {
            ...
            ("mobile", "access on phone", "can i use on phone"): "• Yes, Prolearnworks on mobile browsers and may have an app.",
        ...
        self.faq_exact = {
            "how do i log in to Prolearn?": "Enter the username and password provided and click 'Login'.",
            ...
            "how do i contact support for technical issues?": "Use 'Help' on Prolearnor contact your instructor.",
            "can i access Prolearnon my mobile?": "Yes, it's mobile compatible.",
            "what should i do if my uploaded file is not appearing?": "Refresh, re-upload, or contact support.",
            "how do i log out of Prolearn?": "Click your profile icon and choose 'Logout'.",
    ...
    def set_reminder(self):
        ...
        if not reminder_text:
            self.display_message("Prolearn Chatbot: Reminder text was not provided.")
            return

        reminder_time = simpledialog.askstring("Set Reminder", "Enter reminder time (YYYY-MM-DD HH:MM):")
        if not reminder_time:
            self.display_message("Prolearn Chatbot: Reminder time was not provided.")
            return
